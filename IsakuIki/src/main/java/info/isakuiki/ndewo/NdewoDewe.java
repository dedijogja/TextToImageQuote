...
public class NdewoDewe extends Application {
    ...
    private String statusIklan = NgunuiTerus.GAGAL_LOAD_IKLAN;
    ...
    public void initInterstitial() {
        ...
        interstitial.setAdUnitId(new NgemengKeJeniAh(this).getAdInterstitial());
    }
